# ⚠️ ПРОЕКТ АРХИВИРОВАН И БОЛЬШЕ НЕ ПОДДЕРЖИВАЕТСЯ

Этот набор скриптов выполнил свою историческую задачу и больше не развивается. 
Вся логика, идеи автоматизации и удобство были полностью перенесены в новый современный проект с графическим веб-интерфейсом для панели управления Cockpit.

### 👉 Переходите в новый репозиторий: [samba-easycontrol](https://github.com/lincooln/samba-easycontrol)

*Там вас ждет управление монтированием и расшариванием Samba буквально в пару кликов, автосканер сети и полная независимость от терминала!*
---------------------------------------------------------------------------------------------------------------------------
...
```
    ...
    "!helpme.txt       - краткая справка по использованию"
```
...
### ВНИМАНИЕ! Все пароли хранятся в открытом виде!
- Если для Вас это не приемлемо, не используйте эти скрипты!
- Если хотите можете доработать эти скрипты для шифрования паролей.
